...
# define some vars and consts

VALID_MANUFACTURERS = set([car["manufacturer"]
                           for car in cars.values()])
CAR_NOT_FOUND = "Car not found"
# breakpoint()    used this for testing after wrote code above this point
...
def delete_car(car_id: id) -> JSONResponse:
    pass
...
routes = [
    ...
    Route('/{car_id}/', method='DELETE', handler=delete_car)                                                                                                                               =delete_car)
]
